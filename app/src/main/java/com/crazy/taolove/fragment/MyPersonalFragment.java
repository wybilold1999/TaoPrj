...
import com.crazy.taolove.activity.FeedBackNewActivity;
...
import com.crazy.taolove.db.ExpressionSqlManager;
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
			...
			case R.id.sticker_market:
				...
				break;
			case R.id.feed_back:
				intent.setClass(getActivity(), FeedBackNewActivity.class);
				startActivity(intent);
				break;
		}
	}
